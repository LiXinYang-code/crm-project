...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM 客户关系管理系统 &nbsp;<span style="font-size: 12px;">&copy;19软件工程2班&nbsp;李欣洋</span></div>
